    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                    <button class="btn btn-rounded btn-primary btn-sm">Data Supplier</button>
...
<script>
    ...
    function add_data()
    {
        $.post("<?php echo base_url('supplier/c_supplier/get_form_input')?>",{format : "input_data"}, function(data){
        $(".judul").html("Input Data Supplier");
        $("#form_data").html(data);
    ...
    function  edit_data(kode){
        $.post("<?php echo base_url('supplier/c_supplier/get_form_edit')?>",{format : "edit_data",kode : kode}, function(data){
        $(".judul").html("Edit Data Supplier");
        $("#form_data").html(data);
        $("#modal_master").modal("show");
        }) 
    }
    ...
    table = $('#data_list').DataTable({ 
        ...
        "order"       : [],
        "ajax"        : {
        "url" : "<?php echo base_url('supplier/c_supplier/get_data')?>",
        "type": "POST",
        "data": function ( data ) {
