<form id="form_data_input" autocomplete="off">
    <div class="table-responsive">
        <table class="customers_ts">
            ...
            <tr>
                ...
                <td style="width : 400px;">
                    <select style="width: 99%;" name="nomor_keluar" id="nomor_keluar" class="select2" onchange="get_jenis(this)">
                        <option value="">PILIH</option>
                        <?php foreach ($nomor_cust->result() as $nokl) { ?>
                            <option value="<?php echo $nokl->NomorBarangKeluar ?>"><?php echo $nokl->NomorBarangKeluar ?> - (<?php echo $nokl->NamaCustomer ?>)</option>
                        <?php } ?>
                    </select>
                </td>
            </tr>
        ...
        <table class="customers" style="width: 700px;">
            <tr>
...
<script>
    ...
    function simpan_data(){
        ...
        $.ajax({
            url     : "<?php echo base_url('barang_retur/c_barang_retur/simpan_data') ?>",
            type    : "POST",
