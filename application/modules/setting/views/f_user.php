      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          <div class="header">
            ...
            <button class="btn btn-rounded btn-danger btn-sm" onclick="add_user(this)">Tambah User</button>
          </div>
          <div class="body">
            <div class="table-responsive">
              ...
              <!-- </form> -->
              <table class="table table-striped table-bordered" id="user" style="max-width : 100%;">
                <thead>
                  <tr>
                    <th>No</th>
                    <th></th>
...
<script>
  function add_user()
  {
    $.post("<?php echo base_url('setting/user/get_form_input')?>",{format : "input_data"}, function(data){
  ...
  function  edit_data(kode){
    $.post("<?php echo base_url('setting/user/get_form_edit')?>",{format : "edit_data",kode : kode}, function(data){
  ...
  {
    $.post("<?php echo base_url('setting/user/get_detail_data')?>",{format : "detail_data",kode : kode}, function(data){
  ...
  table = $('#user').DataTable({ 
    ...
    "order"       : [],
    "ajax"        : {
      "url" : "<?php echo base_url('setting/user/get_data')?>",
      "type": "POST",
      "data": function ( data ) {
