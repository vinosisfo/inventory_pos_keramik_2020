    ...
    <div class="table-responsive">
        <table class="customers_ts">
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="hidden" readonly name="id_customer" id="id_customer" value="<?php echo $head->id_customer ?>">
                    <input value="<?php echo $head->NamaCustomer ?>" type="text" name="nama_customer" id="nama_customer" style="width : 200px; max-width: 200px;" maxlength="100">
                </td>
            </tr>
            <tr>
                <td>Alamat</td>
...
<script>
    function simpan_data(){
        ...
        $.ajax({
            url     : "<?php echo base_url('customer/c_customer/update_data') ?>",
            type    : "POST",
